            ...
            <div class="row">
                ...
                <div class="col-md-6">
                  <!-- <h4> Login with facebook <strong> / </strong>Google :</h4>
                    ...
                    <hr />
                     <h4> Login with <strong>myUIC Account  :</strong></h4>
                    <br />
                    <form role="form" name="login" method="POST" action="confirm.php" >
                     <label>Enter Email ID : </label>
                        ...
                        <hr />
                        <center>
                        <button type="submit" class="btn btn-info glyphicon glyphicon-user">&nbspLogin</button>
